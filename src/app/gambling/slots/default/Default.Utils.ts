import { SLOT_ITEMS, BONUS_SYMBOL, SYMBOL_PROBABILITIES } from '@/app/gambling/slots/default/Default.Constants';

// Export the SlotItem type for reuse
export type SlotItem = (typeof SLOT_ITEMS)[number];

// Type for probability map
type ProbabilityMap = Record<SlotItem, number>;

/**
 * Validates that probabilities sum to approximately 1
