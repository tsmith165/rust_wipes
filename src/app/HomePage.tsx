...
export default function HomePage() {
    ...
    return (
        <>
            {/* Render GiveawayOverlay outside the scrollable container */}
            <GiveawayOverlay isOpen={showGiveaway} onClose={() => setShowGiveaway(false)} className="" />

            {/* Main content container */}
            <div ref={contentRef} className="h-[calc(100dvh-50px)] w-full overflow-y-auto">
