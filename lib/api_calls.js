...
async function fetch_upcoming_servers_for_week_day(date, time_zone, min_rank, region, resource_rate, group_limit, game_mode) {
...
async function fetch_battlemetrics_servers(
    ...
    if (use_default) {
        ...
        const queryParams = {
            ...
            'page[key]': offset, // include the page number here
        };

        // Build the URL with the query parameters
        api_call = `https://api.battlemetrics.com/servers?${queryString.stringify(queryParams)}`;
