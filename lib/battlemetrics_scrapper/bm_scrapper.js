...
class Scrapper {
    ...
    async run() {
        ...
        this.endTime = moment();
        output_stats(this.startTime, this.endTime, this.serversParsed, this.serversSkipped, this.serversPosted);
        await insert_scrapper_stats(this.prisma, this.startTime, this.endTime, this.serversParsed, this.serversSkipped, this.serversPosted);
