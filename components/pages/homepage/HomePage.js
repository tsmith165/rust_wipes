...
const HomePage = () => {
    ...
    return (
        <div className="h-full w-full bg-medium block">
            <div className="flex flex-col items-center justify-start overflow-y-auto max-h-full py-5 space-y-5 p-5">
                <div className="w-full max-w-6xl p-5 bg-dark rounded text-light">
                    <h2 className="text-primary text-2xl mt-0">
                        Discover the Latest Server Wipes with rustwipes.net!
                    </h2>
                    <p className="text-light text-base p-5">
