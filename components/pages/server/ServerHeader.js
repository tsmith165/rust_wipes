    ...
    return (
        <div className="flex flex-col md-nav:flex-row justify-between font-bold bg-medium hover:bg-light rounded-t-lg p-5">
            ...
            <div
                ...
                <div className="text-light hover:text-lg hover:font-bold m-0">Port: {port}</div>
                ...
                {hover && !copySuccess && (
                    <div className="absolute bottom-0 left-0 mb-[-40px] ml-2 bg-gray-500 text-white px-3 py-1 rounded z-10">
