...
export default function ServerInfoPage() {
    ...
    const server_header_container = <ServerHeader name={name} />;

    const server_info_container = (
    ...
    const server_description_container = <ServerDescriptionPanel description={rust_description_final} />;
            ...
            <div className="mx-auto flex h-full w-full max-w-7xl flex-col md-nav:flex-row">
                <div className="w-full md-nav:max-h-full md-nav:w-3/5">
                    <div className="min-w-fill flex max-h-full flex-col overflow-y-auto">
                        ...
                        {server_info_container /* Server Info Panel */}
